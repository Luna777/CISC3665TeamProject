...
class Thief{
  ...
  //draw ken as a red ellipse with a letter T.
  void draw()
  {
    fill(204, 0, 0);
  ...
  //find the first gold it can see and return the direction of that gold
  int findDir(){
    float c1=5;
    float c2=0;
